...
| Static S. Generator | Hugo         | [gohugo.io](https://gohugo.io/)                                  |
...
| Archiver          | x        | Oh my Zsh plugin                                 |
| Pager             | less     |                                                  |
| Multiplexer       | tmux     | [tmux.github.io](https://tmux.github.io/)        |
| ╰ Session manager | tmuxp    | [tmuxp.git-pull.com](https://tmuxp.git-pull.com) |
...
| FTP client        | ftp         | [GNU manual - linetutils #ftp-invocation](https://www.gnu.org/software/inetutils/manual/inetutils.html#ftp-invocation) |
...
- Midnight Commander [midnight-commander.org](https://midnight-commander.org/)
  - ls, cd, cp, mv is enought for me
- svn, mercurial
- [Concky](https://github.com/brndnmtthws/conky?tab=readme-ov-file)
- apt-get, aptitude
- typora, zettlr
